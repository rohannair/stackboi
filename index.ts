...
export const initCommand = Command.make('init', {}, () => Effect.promise(() => init()))
...
export const newCommand = Command.make(
  ...
  ({ branchName }) =>
    Effect.promise(() =>
      newStack({ branchName: branchName._tag === 'Some' ? branchName.value : undefined }),
    ),
)
...
export const addCommand = Command.make(
  ...
  ({ branchName }) =>
    Effect.promise(() =>
      addBranch({ branchName: branchName._tag === 'Some' ? branchName.value : undefined }),
    ),
)

export const viewCommand = Command.make('view', {}, () => Effect.promise(() => view()))
  ...
  ({ branchName }) =>
    Effect.promise(async () => {
      const result = await createPR({
        branchName: branchName._tag === 'Some' ? branchName.value : undefined,
      })
      if (!result.success) {
...
export const licenseCommand = Command.make(
  ...
  ({ type }) => Effect.promise(() => showLicense(type._tag === 'Some' ? type.value : undefined)),
)
